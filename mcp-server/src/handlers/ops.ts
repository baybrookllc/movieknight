...
export async function handleGetUserStats(email: string) {
  // Find user by email
...
export async function handleSeedTitles(media_type: string, pages: number) {
...
export async function handleBackfillEmbeddings(limit: number = 50) {
...
export async function handleEdgeFunctionTest(function_name: string, query_string?: string) {
