...
export async function handleTitleLookup(title_id) {
...
export async function handleRecentActivity(limit = 20) {
...
export async function handleSearchCatalog(query, media_type) {
    let q = supabase
        .from("titles")
