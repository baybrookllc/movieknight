...
export async function handleDatabasePerformance(threshold_ms = 100) {
...
export async function handleCheckTableHealth(table_name) {
...
export async function handleFindErrors(table_name) {
...
export async function handleGetSlowRpcCalls(limit = 10) {
    const rpcs = [
